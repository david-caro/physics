...
\pagebreak
\begin{minipage}[posx=600,posy=0]{600px}
\section*{3.4.2 CO2 fixation}
\text{When in dry conditions, plants need to avoid losing water through the stomes, and have to close them during the day or
open them for short periods, to compensate, there's two ways to increase}
\text{the concentration of $CO_2$ available:}
\linebreak
\includegraphics*[width=500px]{images/co2_fixing_c4_cam.png}
\end{minipage}
\pagebreak

\begin{minipage}[posx=600,posy=0]{600px}
\section*{3.5 Cell lifecycle}
\section*{3.5.1 Overview}
\begin{figure}[H]
\includegraphics*[width=600px]{images/cellular_cycle.png}
\end{figure}
\end{minipage}
